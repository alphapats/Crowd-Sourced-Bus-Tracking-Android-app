...
public class TrainFragment extends Fragment {
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        trainButton = (Button) getView().findViewById(R.id.train_btn);
        dataFilePicker = (Button) getView().findViewById(R.id.datafilepicker);
    ...
    private void writeToFile(String fileName, String text, Context context) throws IOException {
        ...
        if (isExternalStorageWritable() && checkpermission(Manifest.permission.WRITE_EXTERNAL_STORAGE)) {
            ...
            File Dir = new File(Root + File.separator + "AVT/Model");
    ...
    private void readTextFromUri(Uri uri) throws IOException {
        ...
        while ((line = reader.readLine()) != null) {
            ...
            if (lineList.get(lineList.size() - 1).equalsIgnoreCase("bus")) {
                text.append("+1 ");
            } else {
                text.append("-1 ");
            }
            ...
            float speed=Float.valueOf(lineList.get(lineList.size() - 5));
